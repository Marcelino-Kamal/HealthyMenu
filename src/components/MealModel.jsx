...
const MealModal = ({ meal, isOpen, onClose, handleAdd }) => {
  ...
  return (
    <div className="fixed inset-0 bg-opacity-40 backdrop-blur-sm flex items-center justify-center z-50 ">
      <div className="bg-[#edf3f7] rounded-xl flex flex-col lg:flex-row p-6 gap-6 shadow-xl">
        {/* Image & Left Section */}
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="grid grid-cols-2 gap-4 mt-8 text-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-m text-gray-500">Difficulty</p>
                <p className="text-lg font-semibold text-[#343C6A]">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-m text-gray-500">Health Score</p>
                <p className="text-lg font-semibold text-[#343C6A]">
                  {meal.healthScore}/10
                </p>
              </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-m text-gray-500">Cook Duration</p>
                <p className="text-lg font-semibold text-[#343C6A]">
                  {meal.duration}
                </p>
              </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-m text-gray-500">Total Steps</p>
                <p className="text-lg font-semibold text-[#343C6A]">
          ...
          <button
            className=" mt-25 bg-[#2682C0] text-white px-4 py-2 rounded-md font-medium"

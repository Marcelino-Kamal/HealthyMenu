...
const Sidebar = () => {
  ...
  return (
    <div className="bg-[#edf3f7] flex h-screen">
      {/* Sidebar */}
      <div className="bg-[#ffffff] text-white w-70 p-5 space-y-2 flex-shrink-0 h-[1200px]  ">
        ...
        <ul className="flex flex-col space-y-20">
          <li className="flex items-center">
            <Link
              to="#"
              className="flex items-center space-x-3 p-2 rounded hover:bg-gray-200 text-[#343c6a] mb-[-100px]"
            >
          ...
          <li
            className={`flex items-center ${
              location.pathname === "/HealthyMenu"
                ? "bg-[#f0f4ff] text-[#0056d2] font-bold rounded-lg"
                : ""
            }`}
          >
            <Link
          ...
          <li className="flex items-center">
            <Link
              to="#"
              className="flex items-center space-x-3 p-2 rounded hover:bg-gray-200 text-[#343c6a] mb-[-700px]"
            >
